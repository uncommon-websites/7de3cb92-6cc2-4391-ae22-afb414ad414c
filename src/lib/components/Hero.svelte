...
<section class="pt-32 pb-16 md:pt-40 md:pb-24 overflow-hidden">
  <div class="container-custom flex flex-col items-center text-center">
    ...
    <h1 class="text-5xl md:text-7xl font-bold tracking-tight text-gray-900 mb-6 max-w-4xl mx-auto leading-[1.1]">
      Automate IT service workflows, <br class="hidden md:block" /> eliminate <span class="text-primary">resolution delays</span>
    </h1>

    <!-- Subheadline -->
    <p class="text-lg md:text-xl text-gray-500 mb-10 max-w-2xl mx-auto leading-relaxed">
      Ravenna uses AI-native orchestration to automatically route and resolve IT service requests across your entire tech stack—no manual ticket management required.
    </p>

    <!-- Buttons -->
    <div class="flex flex-col sm:flex-row items-center gap-4 mb-20">
      <a href="#" class="px-6 py-3 text-sm font-bold bg-primary text-white rounded hover:bg-primary-dark transition-colors uppercase tracking-wide shadow-sm shadow-primary-200">
        Request Demo
      </a>
      ...
      <div class="flex h-[500px] md:h-[600px] text-left bg-white">
        ...
        <div class="flex-1 flex flex-col">
                ...
                <div class="bg-[#1C1C1C] rounded-lg p-4 text-gray-300 shadow-xl border border-gray-800 max-w-2xl mx-auto mt-8">
                    <div class="flex items-center justify-between mb-4 border-b border-gray-700 pb-3">
                        <div class="flex items-center gap-2 text-xs font-medium text-gray-400">
                            <div class="w-4 h-4 rounded-full bg-primary flex items-center justify-center text-white font-bold text-[10px]">R</div>
                            Ravenna AI Assistant
                        </div>
                    ...
                    <div class="relative">
                        <input type="text" placeholder="Route this ticket to the right team..." class="w-full bg-transparent border-none text-sm text-white placeholder-gray-500 focus:ring-0 p-0" />
            ...
            <div class="h-16 border-t border-gray-100 px-6 flex items-center gap-4">
                 ...
                 <div class="w-20 h-10 bg-primary rounded opacity-20"></div>
            </div>
        </div>
